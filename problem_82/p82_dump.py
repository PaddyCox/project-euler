...
for x in range(1, 80):
    for y in range(0, 80):
        if y == 0:
            ...
            option_1 = (int(og_matrix[y-1][x]) + int(matrix_1[y-1][x-1]))
            option_1b = (int(og_matrix[y][x-1]) + int(matrix_1[y-1][x-1]))
        ...
        if y == 79:
            ...
            option_3b = (int(og_matrix[y][x - 1])) + int(matrix_1[y + 1][x - 1])

        min_route = min(option_1, option_2, option_3, option_3b, option_1b)
